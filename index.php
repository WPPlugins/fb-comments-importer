...
function fbsync_comments_free_plugin_menu() {
    ...
    add_submenu_page("fbsync_comments_free", "All Facebook posts", "All Facebook posts", 'manage_options', "fbsync_comments_free_all_posts", "fbsync_comments_free_all_posts_function");
