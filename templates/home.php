...
<hr>
<b>You have <?php echo $hidden_count;?> hidden entries</b>. Basic version is able to connect automatically only entries that contains direct link to some content on the website.
